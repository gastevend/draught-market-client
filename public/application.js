...
/***/ (function(module, exports, __webpack_require__) {
	...
	var preDocLoad = __webpack_require__(7);
	var authEvents = __webpack_require__(8);
	var beerEvents = __webpack_require__(14);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://peaceful-sea-30031.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var preDocLoadActions = function preDocLoadActions() {
	  $('#sign-up').hide();
	  $('#sign-out').hide();
	...
	module.exports = {
	  preDocLoadActions: preDocLoadActions
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.signIn(data).then(ui.signInSuccess).then(beerEvents.onGetBeers).catch(ui.signInFailure);
	...
	var onOrSignIn = function onOrSignIn() {
	  $('#sign-up').hide();
	  $('#sign-in').show();
	  $('#sign-up').trigger('reset');
	  $('#suerror').hide();
	...
	var onOrSignUp = function onOrSignUp() {
	  $('#sign-up').show();
	  $('#sign-in').hide();
	  $('#sign-in').trigger('reset');
	  $('#sierror').hide();
	...
	var onBackToManage = function onBackToManage() {
	  $('#change-password').trigger('reset');
	  $('#change-password').hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var priceLogic = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var market = {
	  beerList: [],
	  updateMarketData: function updateMarketData(data) {
	    market.beerList = [];
	    if (data.beers) {
	  ...
	  runGameLogic: function runGameLogic() {
	    market.beerList.map(function (beer, index) {
	      var priceToString = beer.price.toFixed(2);
	  ...
	  stopGameLogic: function stopGameLogic() {
	    clearTimeout(market.updateBoard
	    // market.beerList = []
	    );
	  },
	  purchaseBeer: function purchaseBeer(index) {
	    market.beerList[index].price += 1.00;
	    var otherBeers = market.beerList.filter(function (beer) {
	      return beer.name !== market.beerList[index].name;
	    });
	    otherBeers.map(function (beers) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onDeleteBeer = function onDeleteBeer(event) {
	  ...
	  api.deleteBeer(id).then(ui.deleteBeerSuccess).then(onGetBeers).catch(ui.deleteBeerFailure);
	};

	var onCancelBeer = function onCancelBeer() {
	  onGetBeers();
	};

	var onEditBeer = function onEditBeer() {
	  var id = $(event.target).attr('data-id');
	...
	var onSaveBeer = function onSaveBeer() {
	  var id = $(event.target).attr('data-id');
	  ...
	  var priceString = $('.beer-price[data-id=' + id + ']').html();
	  ...
	  if (!data.beer.name) {
	    ...
	    api.editBeer(data, id).then(ui.saveBeerSuccess).then(onGetBeers).catch(ui.saveBeerFailure);
	    $('.beer-editable[data-id=' + id + ']').attr('contenteditable', 'false');
	    $('.manage-pg-buttons[data-id=' + id + ']').toggle();
	  }
	};

	var onPurchaseBeer = function onPurchaseBeer() {
	  var index = $(event.target).attr('data-id');
	  $('.market-beer-name[data-id=' + index + ']').animateCss('bounceIn');
	  priceLogic.market.purchaseBeer(index);
	};

	var addBeerListHandlers = function addBeerListHandlers() {
	...
	var onGetBeers = function onGetBeers() {
	  $('.beers-container').empty();
	  api.getBeers().then(ui.getBeersSuccess).then(addBeerListHandlers).catch(ui.getBeersFailure);
	};

	var onAddBeer = function onAddBeer() {
	  event.preventDefault();
	  var data = getFormFields(this);
	  console.log(data
	  ...
	  if (!data.beer.name) {
	    ...
	    api.addBeer(data).then(ui.addBeerSuccess).then(onGetBeers).catch(ui.addBeerFailure);
	    $('#add-beer').trigger('reset');
	    $('#beer-name').focus();
	  }
	};

	var onOpenMarket = function onOpenMarket() {
	...
	var onCloseMarket = function onCloseMarket() {
	  $('#manage-market-page').show();
	  $('#draught-market-page').hide();
	  $('#change-password-link').show();
	  priceLogic.market.stopGameLogic();
	...
	module.exports = {
	  addBeerListHandlers: addBeerListHandlers,
	  onGetBeers: onGetBeers,
	  addHandlers: addHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addBeer = function addBeer(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/beers',
	    method: 'POST',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showBeers = __webpack_require__(17);
	var showMarket = __webpack_require__(38);
	var priceLogic = __webpack_require__(13);

	var getBeersSuccess = function getBeersSuccess(data) {
	  console.log('getting beers back and they are ', data);
	  var showBeersHtml = showBeers({ beers: data.beers });
	  $('#manage-container').append(showBeersHtml);
	  $('.save-button').hide();
	  $('.cancel-button').hide();
	  var showMarketHtml = showMarket({ beers: data.beers });
	...
	var deleteBeerSuccess = function deleteBeerSuccess(data) {
	  console.log('deleted that beer for ya ', data);
	};

	var deleteBeerFailure = function deleteBeerFailure(error) {
	  console.error('error is ', error);
	};

	var saveBeerSuccess = function saveBeerSuccess(data) {
	  console.log('Your beer has been updated and is now ', data);
	};

	var saveBeerFailure = function saveBeerFailure(error) {
	  console.error('error is ', error);
	};

	var addBeerSuccess = function addBeerSuccess(data) {
	  console.log('Your beer has been added ', data);
	};

	var addBeerFailure = function addBeerFailure(error) {
	  console.error('error is ', error);
	};
	...
	module.exports = {
	  ...
	  saveBeerSuccess: saveBeerSuccess,
	  saveBeerFailure: saveBeerFailure,
	  addBeerSuccess: addBeerSuccess,
	  addBeerFailure: addBeerFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <div data-id='"
	    ...
	    + "' class='row one-beer'>\n      <div data-id='"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "' class='col-xs-4 gutterless beer-editable beer-name'>\n        "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\n      </div>\n      <div data-id='"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "' class='col-xs-4 gutterless beer-editable beer-price'>\n        "
	    + alias2(__default(__webpack_require__(37)).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.price : stack1),{"name":"money","hash":{},"data":data,"blockParams":blockParams}))
	    + "\n      </div>\n      <div class='col-xs-4 gutterless'>\n        <button data-id='"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "' class='button-secondary edit-button manage-pg-buttons'>Edit</button>\n        <button data-id='"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "' class='button-error delete-button manage-pg-buttons'>Delete</button>\n        <button data-id='"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "' class='button-success save-button manage-pg-buttons'>Save</button>\n        <button data-id='"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "' class='button-warning cancel-button manage-pg-buttons'>Cancel</button>\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class='row beer-headers'>\n  <div class='col-xs-4 gutterless'>\n    name\n  </div>\n  <div class='col-xs-4 gutterless'>\n    price\n  </div>\n  <div class='col-xs-4 gutterless'>\n    actions\n  </div>\n</div>\n<div class='container-fluid list-o-beers'>\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <div data-id='"
	    ...
	    + "' class='col-xs-4 gutterless market-beer-name'>\n        "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\n      </div>\n      <div data-id='"
	    + alias2(alias1((data && data.index), depth0))
	    + "' class='col-xs-4 gutterless market-beer-price'>\n        "
	    + alias2(__default(__webpack_require__(37)).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.price : stack1),{"name":"money","hash":{},"data":data,"blockParams":blockParams}))
	    + "\n      </div>\n      <div class='col-xs-4 gutterless'>\n        <button data-id='"
	    + alias2(alias1((data && data.index), depth0))
	    + "' class='button-secondary purchased-button'>Purchased</button>\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
